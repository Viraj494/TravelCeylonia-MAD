...
data class BookingData(var vehicle: String,var fromDate: String, var toDate : String, var noOfDays : Long, var totalCost : Long,var bookedBy : String,var cost: Int, var isPaid:String):
    Parcelable {
